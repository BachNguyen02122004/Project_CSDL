        ...
        <div id="container">
            <div class="content-checkout">
                <div id="infomation">
                    ...
                    <div class="info-user">
                        <div class="infomation-item">Bách Nguyễn(+84) 325453480 2c Ngách 15 Ngõ 20 Hồ Tùng Mậu, Phường Mai Dịch, Quận Cầu Giấy, Hà Nội</div>
                        <div class="info-default">Mặc định</div>
                        <a href="#" class="change-item">Thay đổi </a>
                    </div>
                </div>
